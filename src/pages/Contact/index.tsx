...
return (
    ...
    <h1 className="text-3xl font-anton font-bold mb-6 text-center">
        Kontaktinformasjon
    </h1>
    ...
    <div className="w-full mt-8">
        <div className="w-full h-96 rounded-lg overflow-hidden shadow-lg">
            ...
            <div>
                ...
                <p className="text-lg font-roboto font-regular mb-4">Styret til KIL Håndball består av Bent Rode-Christoffersen, Vidar Svartkjønnli, Svein Thorstensen, 
                Elin Maria Vendela Skoglund, Ole-Erik Ruud, Bjørn erik Johnsen, Linda skarstad og Hanne Fiskerud.</p>
            <h3 className="text-xl font-anton font-bold mb-2">Styreleder</h3>
            <p className="text-lg font-roboto font-medium">Bent Rode-Christoffersen</p>
            <ul className="mb-4 text-lg font-roboto">
                ...
                <li>
                <strong>Telefon:</strong> <a href="tel:+4790969435" className="text-kilsvart font-regular hover:underline">90969435</a>
                </li>
            </ul>
            ...
            <ul className="mb-4 text-lg font-roboto">
                ...
                <li>
                <strong>Telefon:</strong> <a href="tel:+4790252766" className="text-kilsvart font-regular hover:underline">90252766</a>
                </li>
            </ul>

            <h3 className="text-xl font-anton font-bold mb-2">Sportslig</h3>
            <p className="text-lg font-roboto font-medium">Sportslig utvalg består av Erik Elseth, Sara Bourne, Charlotte Egnersson og Jon Are Haveråen-Brattås. Har du spørsmål til sportslig, send mail eller ring Jon Are på kontaktinfo under.</p>
            <ul className="text-lg font-roboto">
                ...
                <li>
                <strong>Telefon:</strong> <a href="tel:+4791607759" className="text-kilsvart font-regular hover:underline">91607759</a>
                </li>
            </ul>
            </div>
        </div>
