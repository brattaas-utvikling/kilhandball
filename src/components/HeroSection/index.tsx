        ...
        <div className="container mx-auto py-16 px-4 md:px-8 md:py-24">
            <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="flex flex-col justify-center text-white order-2 md:order-1">
                    ...
                    Kongsvinger Idrettslag, med en stolt historie som strekker seg tilbake til 1892, er mer enn bare en idrettsklubb; det er et fellesskap som binder sammen generasjoner av idrettsentusiaster i Kongsvinger kommune.
                    </p>
                    <div className="mt-4">
                ...
                <div className="w-full h-[400px] md:h-[500px] overflow-hidden rounded-lg order-1 md:order-2">
                    <Swiper
                        ...
                        pagination={{ 
                            clickable: true,
                            bulletClass: 'swiper-pagination-bullet bg-white/50 w-2 h-2 inline-block rounded-full mx-1 cursor-pointer',
