  ...
  return (
    <div className="container mx-auto pb-12">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-xl font-semibold mb-4 text-kilred">Brukerveiledning for Håndball Live</h2>
        ...
        <div className="prose max-w-none">
          ...
          <div className="space-y-6 mb-8">
            <div>
              <h3 className="font-bold mb-2">Standard versjon - Digital kamprapport</h3>
            ...
            <div>
              ...
              <ul className="list-disc pl-6">
                <li>Føre hendelser for statistikk (parallelt med Digital kamprapport)</li>
          ...
          <ul className="list-disc pl-6 mb-6">
            <li><strong>Kamper LIVE</strong> (tilknyttet involvert klubb eller lag)</li>
            <li><strong>Kampansvarlig</strong> (tilknyttet involvert klubb eller lag)</li>
          </ul>
